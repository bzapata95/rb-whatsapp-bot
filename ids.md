"FOUNDCHEESE - STOCK 🚨" → ID: 120363403061146426@g.us
   Copia ese ID a .env como GRUPO_ORIGEN_ID o GRUPO_DESTINO_ID y reinicia el bot.

[Grupo] "GASTOS CASA 💍" → ID: 120363404527181585@g.us
   Copia ese ID a .env como GRUPO_ORIGEN_ID o GRUPO_DESTINO_ID y reinicia el bot.
